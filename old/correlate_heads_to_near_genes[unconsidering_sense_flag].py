...
gene_attibutes = pd.read_table(pardir/'genome_annotation/gene_annotations.gff3', names=GFF3_COLUMNS, usecols=['attributes'])['attributes']
head_attibutes = pd.read_table(pardir/'genome_annotation/head_annotations.gff3', names=GFF3_COLUMNS, usecols=['attributes'])['attributes']
...
relations = pd.read_table(pardir/f'genome_annotation/head_genes_relations{nosense_flag}.tsv')
