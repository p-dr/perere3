...
perere3_vs_genoma = read_csv(pardir/f'alinhamentos/perere3_vs_genoma.bl', header=None, names=COLUMNS.split(), sep='\\s+')
sr3_vs_genoma = read_csv(pardir/f'alinhamentos/sr3_vs_genoma.bl', header=None, names=COLUMNS.split(), sep='\\s+')
...
filtered_outpath = pardir/'alinhamentos/filtered_perere3_vs_genoma.bl'
...
discarded_outpath = pardir/'scripts/perere3_indices_filtrados.csv'
print(f"Escrevendo posições das linhas removidas de 'perere3_vs_genoma.bl' em '{str(discarded_outpath)}'...")
